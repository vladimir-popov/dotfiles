...
nmap("<space>a", "<cmd>lua require('telescope.builtin').find_files({" .. ignore_patterns .. "})<CR>")
...
-- find buffers
nmap("<space>w", "<cmd>lua require('telescope.builtin').buffers()<cr>")
-- find recent files
...
imap("<leader>r", "<cmd>lua require('telescope.builtin').registers()<cr>")
-- live grep
...
nmap("<space>sm", "<cmd>lua require('telescope.builtin').lsp_document_symbols({symbols={'method', 'function'}})<CR>")
nmap("<space>sf", "<cmd>lua require('telescope.builtin').lsp_document_symbols({symbols='field'})<CR>")
