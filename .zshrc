...
NNN_P_OPEN_PWD_IN_NVIM='-!nvim*'
NNN_P_ARD='-!'$ARDENS_PATH'/Ardens file=$(pwd -P)"/$nnn"'
NNN_P_HELP='-!echo "$NNN_PLUG"'
export NNN_PLUG="h:$NNN_P_HELP;f:fzcd;n:nuke;d:diffs;i:batview;v:$NNN_P_OPEN_PWD_IN_NVIM;p:preview-tui;c:$NNN_P_PWD;a:$NNN_P_ARD;o:$NNN_P_OPEN;z:autojump;"
